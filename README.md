...
local trueData = "ed2be4344bc54c129a55252017093ed8"
local falseData = "08bf18aa79634020b94c42b669303aa8"

KeyGuardLibrary.Set({
  publicToken = "0880adc1fd834bcdafa26400ae6cc524",
  privateToken = "4ed25227a7a649d284b0b75f70399b96",
  trueData = trueData,
  falseData = falseData,
})
                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Gui Hub v1 Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("Bem Vindo Ao Gui Hub")
...
Tabs.Main:AddButton({
        Title = "Gui Hub v1 Discord Server",
...
Fluent:Notify({
    Title = "Gui Hub v1",
    Content = "Thanks For Using Gui Hub v1",
    Duration = 8
})
